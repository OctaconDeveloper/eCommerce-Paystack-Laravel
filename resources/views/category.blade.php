...
<?php
$categoryName=str_replace('-',' ',Request::route('id'));
$catCount=App\category:: where('categoryName',$categoryName)->count();
if($catCount > 0){
  $cat=App\category:: where('categoryName',$categoryName)->first();
  $categoryID=$cat->categoryID;
  $products=App\product::where('categoryID',$categoryID)->inRandomOrder()->get();
}
?>
<title>{{ucwords($categoryName)}} Category</title>
        ...
        <div class="row">
          <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
              <h1 class="page-title">{{ucwords($categoryName)}}</h1>
                            ...
                            <div class="action-buttons">
                              <div class="yith-wcwl-add-to-wishlist add-to-wishlist-20">
                                <div class="yith-wcwl-add-button show" style="display:block">
                                  <a data-product-id="20" data-product-type="variable" class="add_wishlist">
                                    Add to Wishlist
                                  </a>
                                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-12">
              <aside id="text-2" class="widget clearfix widget_text">
                <div class="textwidget">
                  <p>
                    <img src="./Shop Sidebar _ 4 Products – Page 2 – MediaCenter_files/banner-simple.jpg" alt="Canon Ad" width="250" height="114">
                  </p>
                </div>
              </aside>
            </div>
