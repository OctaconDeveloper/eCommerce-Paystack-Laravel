  ...
  <div id="post-914" class="post-914 page type-page status-publish hentry">
    <div class="section section-page-title inner-xs">
      <div class="page-header">
        <h2 class="page-title" itemprop="name">Terms and Conditions</h2>
      </div>
    </div>
    <div class="entry-content inner-bottom-sm" itemprop="mainContentOfPage">
      ...
      <section class="section intellectual-property">
        <h2>Contact Us</h2>
        <p>If you have any questions about this Agreement, please contact us filling this
          <a href="{{Config::get('constant.options.sitelink')}}contact">contact form</a>
        </p>
      </section>
    </div>
  </div>
